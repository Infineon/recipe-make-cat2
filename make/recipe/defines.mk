...
else ifneq (,$(findstring $(DEVICE),$(CY_DEVICES_WITH_DIE_PSOC4ASF2)))
CY_PSOC_DIE_NAME=PSOC4ASF2
else ifneq (,$(findstring $(DEVICE),$(CY_DEVICES_WITH_DIE_PAG2S)))
CY_PSOC_DIE_NAME=PAG2S
CY_OPENOCD_DEVICE_CFG=pag2s.cfg
CY_OPENOCD_CHIP_NAME=psoc4hv
else
...
_MTB_RECIPE_SVD_SUB_PATH=devices/svd/$(CY_STARTUP).svd
CY_ECLIPSE_OPENOCD_SVD_PATH=\$${cy_prj_path}/$(SEARCH_mtb-pdl-cat2)/$(_MTB_RECIPE_SVD_SUB_PATH)
CY_VSCODE_OPENOCD_SVD_PATH=$(SEARCH_mtb-pdl-cat2)/$(_MTB_RECIPE_SVD_SUB_PATH)
...
MTB_ECLIPSE_TEXT_FILE_CMD+=echo "&&CY_OPENOCD_OTHER_RUN_CMD&&=$(CY_OPENOCD_OTHER_RUN_CMD_ECLIPSE)" >> $(MTB_CORE_MAKE_ECLIPSE_TEXTDATA_FILE);\
				echo "&&CY_JLINK_CFG_PROGRAM&&=$(DEVICE)" >> $(MTB_CORE_MAKE_ECLIPSE_TEXTDATA_FILE);\
				echo "&&CY_JLINK_CFG_DEBUG&&=$(DEVICE)" >> $(MTB_CORE_MAKE_ECLIPSE_TEXTDATA_FILE);\
				echo "&&CY_JLINK_CFG_ATTACH&&=$(CY_JLINK_DEVICE_CFG_ATTACH)" >> $(MTB_CORE_MAKE_ECLIPSE_TEXTDATA_FILE);\
				echo "&&CY_XRES_AVAILABLE&&=$(CY_XRES_AVAILABLE)" >> $(MTB_CORE_MAKE_ECLIPSE_TEXTDATA_FILE);\
				echo "&&CY_RESET_CONFIG&&=$(CY_RESET_CONFIG)" >> $(MTB_CORE_MAKE_ECLIPSE_TEXTDATA_FILE)
endif
...
ifneq (,$(findstring $(DEVICE),$(CY_DEVICES_WITH_DIE_PSOC4AS1) $(CY_DEVICES_WITH_DIE_PSOC4AS2) $(CY_DEVICES_WITH_DIE_PSOC4AS3) $(CY_DEVICES_WITH_DIE_PSOC4AMC) $(CY_DEVICES_WITH_DIE_PSOC4AS4) $(CY_DEVICES_WITH_DIE_CCG3PA) $(CY_DEVICES_WITH_DIE_CCG6) $(CY_DEVICES_WITH_DIE_CCG3) $(CY_DEVICES_WITH_DIE_PMG1S3) $(CY_DEVICES_WITH_DIE_CCG7S) $(CY_DEVICES_WITH_DIE_PAG2S)))
